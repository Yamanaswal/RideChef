...
import com.ripenapps.ridechef.databinding.FoodItemBinding

class MyFoodRecyclerViewAdapter(private val context: Context) :
    ...
    inner class ViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
        var binding: FoodItemBinding? = DataBindingUtil.bind(view!!)
